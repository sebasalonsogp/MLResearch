...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, nclass=10, channels=3, **kwargs):
...
#default scale 12
def DenseNetCifar(nclass, scale, channels, **kwargs):
    return DenseNet(Bottleneck, [6,12,24,16], growth_rate=scale, nclass=nclass, channels=channels, **kwargs)
